    ...
    <div className="menu-container">
      ...
      <div className="menu-color-select">
        <input
          ...
          checked={colorValue === "Naturel (076)"}
        />
        <label className="color-1" htmlFor="color-1">
          <div>
            <img
              src="https://contentstore.triumph.com/transform/e2ea6c2b-0469-4c40-9f4a-6057a734aa12/30_10221469_00RB_1.png?"
              alt="Color-1"
            />
          </div>
        </label>
        <input
          ...
          value={"Ginger"}
          onChange={changeColor}
          checked={colorValue === "Ginger"}
        />
        <label className="color-2" htmlFor="color-2">
          <div>
            <img
              src="https://contentstore.triumph.com/transform/3fbd472b-f317-44e4-a6e0-3d38ffb6d776/30_10221469_00YO_1.png?"
              alt="Color-2"
            />
          </div>
        </label>
      ...
      <div className="menu-size">
        ...
        <button>
          <img
            width={"23px"}
            src="https://png.klev.club/uploads/posts/2024-05/png-klev-club-qzg8-p-mernaya-lenta-png-13.png"
            alt=""
          />
      ...
      <div className="menu-btn-add">
        ...
        <button onClick={likeHandler} className="menu-btn-add-2">
          {likeIcon}
          {likeTest}
        </button>
      </div>
      ...
      <div className="menu-delivery">
        <p>
          <PiTruckLight className="truck" />
          <span className="delivery-text">Become a </span>
          <span>My Triumph</span>{" "}
          <span className="delivery-text">
            member and receive your deliveries for free!
          </span>
        </p>
      </div>
      ...
      <div className="pay-conatiner">
        ...
        <img
          ...
          alt="PayPal"
        ></img>
        <span>Pay in 3 interest-free payments on purchases from</span>{" "}
        <span>£30-£2,000.</span> <span>Learn more</span>
      </div>
    </div>
  );
}
